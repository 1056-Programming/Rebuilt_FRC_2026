...
public class RobotContainer1 {
    ...
    private final AligntoCenter c_alignToCenter = new AligntoCenter(drivetrain);
    ...
    private void configureAuto() { //Create Code Based on The Event Makers
        ...
        NamedCommands.registerCommand("Pivot Down", c_intakeCommand.setIntakeState(IntakeStates.DOWN));
        NamedCommands.registerCommand("Intake Stop", c_intakeCommand.setIntakeState(IntakeStates.STOP));
        NamedCommands.registerCommand("Pivot Up", c_intakeCommand.setIntakeState(IntakeStates.UP));
...
;
    ...
    public Command getAlignToCenterCommand() {
        return c_alignToCenter;
    }
}